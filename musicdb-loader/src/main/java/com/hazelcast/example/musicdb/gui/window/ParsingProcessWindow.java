...
public class ParsingProcessWindow extends Window {

    private final Label fileName;
    private final Label processRecords;
    private final ProgressBar fileStatus;
    private final ProgressBar totalStatus;

    public ParsingProcessWindow(String title) {
        super(title);
        this.fileName = new Label("");
        this.addComponent(this.fileName);
        this.processRecords = new Label("");
        this.addComponent(this.processRecords);
    ...
    public Label getProcessRecords() {

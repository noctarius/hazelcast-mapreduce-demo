...
import com.hazelcast.example.musicdb.gui.window.HazelcastConnectionWindow;

public class HazelcastConnectionStep extends Step {

    private final HazelcastConnectionWindow window = new HazelcastConnectionWindow();
    ...
    protected StepOperation createOperation() {
        return new StepOperation() {
            ...
            public void execute() throws Exception {
                window.getOk().setAction(new Action() {
                    @Override
